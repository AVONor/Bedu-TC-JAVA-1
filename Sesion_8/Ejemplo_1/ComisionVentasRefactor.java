package Sesion_8.Ejemplo_1;

public class ComisionVentasRefactor {
    public static void main(String[] args) {
        String nombreAgente = "Carlos";
        double monto_ventas = 30000; 

        double comisionCalculada = calcularComision(monto_ventas);
        mostrarComision(nombreAgente, comisionCalculada); 

        if (estaCercaDelSiguienteNivel(monto_ventas)){
            System.out.println("i" + nombreAgente + "está cerca del siguiente nivel!");
        }
    }
